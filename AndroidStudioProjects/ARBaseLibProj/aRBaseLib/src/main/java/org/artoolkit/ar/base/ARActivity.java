...
public abstract class ARActivity extends /*AppCompat*/Activity implements CameraEventListener {
    ...
    public void cameraPreviewStarted(int width, int height, int rate, int cameraIndex, boolean cameraIsFrontFacing) {
        ...
        ////DIEGO   if (ARToolKit.getInstance().startWithPushedVideo(width, height, null, cameraIndex, cameraIsFrontFacing)) {
        if (ARToolKit.getInstance().startWithPushedVideo(width, height, null,null, cameraIndex, cameraIsFrontFacing)) {

               // if (ARToolKit.getInstance().startWithPushedVideo(width, height, "Test", cameraIndex, cameraIsFrontFacing)) {
            if (ARToolKit.getInstance().startWithPushedVideo(width, height, "Test", null, cameraIndex, cameraIsFrontFacing)) {
